...
```sh
sudo chown -R 33:0 /mnt/flex
```

```sh
sudo chmod -R 750 /mnt/flex
```
...
```sh
sudo chown -R www-data:www-data /mnt/flex/nextcloud
```

```sh
sudo find /mnt/flex/nextcloud/ -type d -exec chmod 750 {} \;
```

```sh
sudo find /mnt/flex/nextcloud/ -type f -exec chmod 640 {} \;
```
